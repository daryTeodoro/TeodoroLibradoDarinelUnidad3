...
echo '
<div class="AlignEnd">
<ion-icon name="close" class="IconoClose" onclick="closeOption(\'VistaExpediente\')">
</ion-icon></div>
';

echo '
<form method="post" action="" class="ContenedorCards" id="ContenedorCards2">
';
...
if ($contar == 1) {
	...
	<button type='button' class='BotonDataPac' onclick='mispacientesexpediente(".$identificar['correo'].")'>
