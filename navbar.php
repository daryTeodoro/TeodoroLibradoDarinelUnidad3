        ...
        <div class="Contenedor">
            ...
            <div id="mainListDiv" class="main_list">
                <ul class="navlinks fo">
                    <li id="AChatbot"><a href="chatBot.php">ChatBot</a></li>
                    <li id="ARegistro"><a href="forms.php#Registrar">Crear Cuenta</a></li>
                    <li id="ALogin"><a href="forms.php">Iniciar Sesión</a></li>
                </ul>
            </div>
