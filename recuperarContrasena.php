...
<html lang="en">
  ...
  <body>
    <!--Formulario de para Recuperar Contraseña por correo-->
    <div class="FormCorreo" id="FormCorreo">
      ...
      <div>
        <!--Botones para continuar y cancelar proceso-->
      ...
      <p class="Fuente-Monomaniac cambiar" align="justify"><b onclick="formnumber()">Recuperar Cuenta Paciente</b></p> <!--Cambiar de formulario-->
    </div>

    <!--Formulario para recuperar contraseña por preguntas-->
...
/*Funcion para ver el formulario de recuperar contraseña por correo*/
function formcorreo(){
  contenedorFormCorreo.style.display = 'flex';
  contenedorFormNumber.style.display = 'none';
}
/*Funcion para ver el formulario de recuperar contraseña por preguntas*/
function formnumber(){
  contenedorFormCorreo.style.display = 'none';
  contenedorFormNumber.style.display = 'flex';
}

/*Accion para Comprobar que el numero telefonico esta registrado*/
...
/*Accion para Comprobar que el correo esta registrado*/
    $("#EnviarCorreo").click(function() {
        var correo = $('#Correo').val();

        if ($("#Correo").val() == '') {
          alert("Ingrese tu Correo");
        } else {
            $.ajax({
                type: 'POST',
                url: 'Procesos/rectificar-CC.php',
                data: {user: correo}, // Se envia el dato
                success: function(response) {
                    if (response == 2) {
                        alert('El correo no esta asociado');
                    } else {
                        contenedorFormCorreo.style.display = 'none';
...
/*Boton para cancelar el proceso de recuperar contraseña*/
function cancelar(){
