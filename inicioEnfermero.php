...
<!--*****************QUIERO CAMBIAR EL TAMAÑO DE LA LISTA DE TAREAS-->
    ...
    <div class="VistaMensajes" id="VistaMensajes">
      <div class="AlignEnd"><ion-icon name="close" class="IconoClose" onclick="closeOption('VistaMensajes')"></ion-icon></div>
      <form method="post" action="" class="ContenedorCards" id="ContenedorCards4">
        <script type="text/javascript">
